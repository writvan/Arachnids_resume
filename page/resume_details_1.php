<div class="container my-3">
  <form method="post">
      <div class="row justify-content-between">
          ...
          <div class="row col-6 mb-3">
            ...
            <div class="">
              <input type="text" class="form-control" name="headline" placeholder="enter your job description" >
            </div>
          </div>
      </div>
    <div class="row mb-3">
    ...
    <div class="row col-6 mb-3">
      ...
      <div class="">
        <input type="mobile" class="form-control" placeholder="Enter your Mobile Number" >
      </div>
    </div>
  </div>
    <div class="row mb-3">
    ...
    <hr>
    <div class="row mb-3">
      <label for="inputEmail3" class="col-sm-2 col-form-label fs-4">Skills</label>
      <div id="skills">
  ...
  <!-- education -->
    <hr>
    <div class="mb-3">
      <label for="inputEmail3" class="col-sm-2 col-form-label fs-4 text-left">Education</label>
...
<!-- experience  -->
    <hr>
    <div class="mb-3">
      <label for="inputEmail3" class="col-sm-2 col-form-label fs-4">Experience</label>
      <div id="exps" class="" >
