...
foreach($resumes as $resume){
  ...
  <div class="card-body">
    ...
    <a href="#" class="btn btn-sm btn-danger"><i class="bi bi-trash3-fill"></i> Delete</a>
...
<div class="card my-3">
  <div class="card-body">
    <h1 class="text-center text-muted" ><i class="bi bi-cloud-drizzle-fill"></i> No Resume Created</h1>
  </div>
</div>
  <?php
}
